...
onload = () => {
  ...
  planet = sphere(5);
  planet.scale(0.2, 0.2, 0.2);
  planet.translate(-0.8, 0, 0);

  planet2 = sphere(5);
  planet2.scale(0.2, 0.2, 0.2);
  planet2.translate(0.8, -0.3, 0);

  planet3 = sphere(5);
  planet3.scale(0.2, 0.2, 0.2);
  planet3.translate(1.2, 0.5, 0);
