...
function render() {
  ...
  // Rehman continued to search hwo to rotate them
  // mostly rotation is okay but not what we want
 // sun
...
// 1st planet
let mvm2;
t_mat = translate(1.7, 0, 0);
s_mat = scalem(0.5, 0.5, 0.5); // Scaling factor for the 1st planet
...
// 2nd planet
let mvm3;
t_mat2 = translate(2.6, 0, 0);
s_mat2 = scalem(0.3, 0.3, 0.3); // Scaling factor for the 2nd planet
...
// 3rd planet
let mvm4;
t_mat3 = translate(3.2, 0, 0);
s_mat3 = scalem(0.2, 0.2, 0.2); // Scaling factor for the 3rd planet
