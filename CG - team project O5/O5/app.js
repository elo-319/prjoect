...
onload = () => {
  ...
  planet.orbitRadius = 1.5;    // Orbit radius relative to the sun
  planet.orbitSpeed = 0.001;   // Orbit speed in radians per frame
  planet.rotationSpeed = 0.005; // Rotation speed in radians per frame
  planet.axisTilt = [1, 0, 0]; // Axis tilt for rotation
  ...
  planet2.orbitSpeed = 0.0005;
  planet2.rotationSpeed = 0.01;
